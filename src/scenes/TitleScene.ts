...
export default class TitleScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(128, 50, 'DIVE FOR PRINCESS', {
      fontSize: '16px',
      color: '#ffffff',
    ...
    this.add.text(128, 75, 'Save the Princess!', {
      fontSize: '12px',
      color: '#ffaa00',
      fontFamily: 'monospace'
    }).setOrigin(0.5);

    this.add.text(128, 105, 'The princess ate too many cakes\nand fell from the sky!\nCatch her before she hits the ground!', {
      fontSize: '8px',
      color: '#cccccc',
      fontFamily: 'monospace',
      align: 'center',
    ...
    const startText = this.add.text(128, 150, 'Press ENTER to start', {
      fontSize: '10px',
      color: '#00ff00',
      fontFamily: 'monospace'
    }).setOrigin(0.5);

    this.add.text(128, 175, 'Controls:\nARROWS: Move\nZ: Dive through rubbles\nSHIFT: Pause', {
      fontSize: '7px',
      color: '#888888',
      fontFamily: 'monospace',
      align: 'center',
